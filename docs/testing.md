...
Latest validated local outcome on `2026-06-03`:
...
- Android `app:testDebugUnitTest` green again through the ASCII-path wrapper
- Android `app:lintDebug` green with `0` errors and `20` warnings
