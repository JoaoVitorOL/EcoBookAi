-- EcoBook IA - Runtime PostgreSQL Schema
-- Version: 2.0
-- Date: 2026-05-05
-- Source of truth: Flyway migrations V1, V2, and V4 plus current JPA mappings
-- This file documents the CURRENT schema shape, not future phases.
...
-- `google_id`, `deleted_at`, audit-log tables, and FCM persistence tables are
-- not part of the current runtime schema.
